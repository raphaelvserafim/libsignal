import { SenderKeyDistributionMessageProto } from './proto.js'
  ...
  constructor(
    ...
    if (serialized) {
      try {
        ...
        const distributionMessage = SenderKeyDistributionMessageProto.decode(message)
        ...
        const err = new Error(
          `Failed to decode SenderKeyDistributionMessage: ${e instanceof Error ? e.message : String(e)}`,
        )
      ...
      const message = SenderKeyDistributionMessageProto.encode(
