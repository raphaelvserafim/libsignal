...
describe('SessionEntry', () => {
  ...
  describe('serialize / deserialize', () => {
    it('should roundtrip a session entry', () => {
      ...
      expect(deserialized.currentRatchet.ephemeralKeyPair.pubKey.equals(entry.currentRatchet.ephemeralKeyPair.pubKey)).toBe(true);
      expect(deserialized.currentRatchet.ephemeralKeyPair.privKey.equals(entry.currentRatchet.ephemeralKeyPair.privKey)).toBe(true);
      expect(deserialized.currentRatchet.lastRemoteEphemeralKey.equals(entry.currentRatchet.lastRemoteEphemeralKey)).toBe(true);
